...
if( isset($_INPUT['application_no']) && isset($_INPUT['mode_of_payment']) && isset($_INPUT['name_of_bank'])
        && isset($_INPUT['transaction_id']) && isset($_INPUT['transaction_date']) && isset($_INPUT['recaptcha_token']) ){
